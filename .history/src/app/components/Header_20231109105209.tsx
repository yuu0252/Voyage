            ...
            <nav>
                <ul className="g-nav">
                    ...
                    <li className="has-child">
                        <h3 className="g-nav__title accordion__title">コンテンツ&nbsp;<img src="./images/矢印ボタン　下3.png" alt="アイコン:矢印 下" className="accordion__icon"></h3>
                    ...
                    <li className="has-child">
                        <h3 className="g-nav__title accordion__title">SNSシェア&nbsp;<img src="./images/矢印ボタン　下3.png" alt="アイコン:矢印 下" className="accordion__icon"></h3>
                        <ul className="accordion">
